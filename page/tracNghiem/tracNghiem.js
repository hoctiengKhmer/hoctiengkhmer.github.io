...
function choseIncorectAnswer(correctAnswerID){ //tạo đáp án sai
...
for (i=0; i<=MAX_QUESTION -1; i++){                           //tạo câu hỏi
...
function submit(){
    ...
    resultNotification(score)
}


function resultNotification(score){
